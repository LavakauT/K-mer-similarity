...
write.table(output,
            paste0(dir, file_name, '_top_sim_two_algo_dap.txt'),
            row.names = F,
            quote = F,
            sep = '\t')
...
pdf(paste0(dir, file_name, '_top_sim_tow_algo_dap.pdf'))
...
save.image(file = paste0(dir, paste(file_name, 'tow_algo_dap.RData', sep = '_')))
